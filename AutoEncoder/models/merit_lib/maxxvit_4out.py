""" MaxVit and CoAtNet Vision Transformer - CNN-gray Hybrids in PyTorch
...
from AutoEncoder.models.merit_lib.models_timm.helpers import build_model_with_cfg, checkpoint_seq, named_apply
from AutoEncoder.models.merit_lib.models_timm.fx_features import register_notrace_function
from AutoEncoder.models.merit_lib.models_timm.layers import Mlp, ConvMlp, DropPath, ClassifierHead, trunc_normal_tf_, LayerNorm2d, \
    LayerNorm
from AutoEncoder.models.merit_lib.models_timm.layers import create_attn, get_act_layer, get_norm_layer, get_norm_act_layer, \
    create_conv2d
from AutoEncoder.models.merit_lib.models_timm.layers import to_2tuple, extend_tuple, make_divisible, _assert
from AutoEncoder.models.merit_lib.models_timm.registry import register_model
from AutoEncoder.models.merit_lib.models_timm.vision_transformer_relpos import RelPosMlp, \
    RelPosBias  # FIXME move these to common location
...
class Stem(nn.Module):
    ...
    def __init__(
        ...
        self.stride = 1
        self.conv0 = create_conv2d(1, 16, 1, stride=self.stride)
        # self.conv1 = create_conv2d(16, 32//4, kernel_size, stride=self.stride)
        # # self.norm1 = norm_act_layer(out_chs[0])
        # self.conv2 = create_conv2d(32//4, 32//2, kernel_size, stride=1)

        self.conv1 = create_conv2d(16, 32//2, kernel_size, stride=self.stride)
        # self.norm1 = norm_act_layer(out_chs[0])
        self.conv2 = create_conv2d(32//2, 32, kernel_size, stride=1)

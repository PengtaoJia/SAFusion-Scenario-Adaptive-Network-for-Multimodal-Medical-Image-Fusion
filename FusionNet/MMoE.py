...
class SparseDispatcher(object):
    ...
    def dispatch(self, inp):
        ...
        try:
            # print(self._batch_index,self._part_sizes)
            # print(torch.split(inp_exp, self._part_sizes, dim=0))
...
class MMoE(nn.Module):
    ...
    def __init__(self, input_size, output_size, num_experts, hidden_size, noisy_gating=True, k=4,task_num=3):
        ...
        # self.experts = nn.ModuleList([ConvFusionLayer(input_size) for i in range(self.num_experts)])
    ...
    def noisy_top_k_gating(self, x, train, task_index,noise_epsilon=1e-1):
        ...
        # print(x)
        # print(self.w_gate[task_index])
        # print("专家概率：",clean_logits)
    ...
    def forward(self, x,task_index, loss_coef=1e-3):
        ...
        # print(task_index,gates.shape,gates)
        ...
        for i in range(self.num_experts):
            temp=expert_inputs[i]
            expert_outputs.append(self.experts[i](temp))
